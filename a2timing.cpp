...
int main(int argc, char* argv[]){
    ...
    double percentOpen;
    if(argc != 1){
        percentOpen=atof(argv[1]);
    }
    else{
        cout << "no value supplied for percent open, using 35%" << endl;
        cout << "use: a.out <percentOpen> to supply percentage of open space" << endl;
        percentOpen=0.35;
    }
    try{
        ...
        LPTable<int> hashtable(hashtableMax,percentOpen);
        Timer t2;
